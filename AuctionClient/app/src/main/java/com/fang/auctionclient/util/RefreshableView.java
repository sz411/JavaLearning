...
public class RefreshableView extends LinearLayout implements OnTouchListener{
    ...
    public static final long ONE_HOUR = 60 * ONE_MINUTE;//一小时的毫秒
    ...
    private View footer;//上拉头的View
    private ListView listView;//需要去下拉刷新的ListView
    private ProgressBar headProgressBar;//刷新时显示的进度条
    private ProgressBar footProgressBar;//加载时显示的进度条
    ...
    private int footerViewHeight;//上拉头的高度
    ...
    public RefreshableView(Context context, AttributeSet attrs) {
        ...
        footer = LayoutInflater.from(context).inflate(R.layout.pull_to_load, null, true);
        headProgressBar = (ProgressBar) header.findViewById(R.id.waitForNet);
        footProgressBar = (ProgressBar) footer.findViewById(R.id.waitForNet);
